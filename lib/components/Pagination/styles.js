...
var Page = _styledComponents.default.div.withConfig({
  displayName: "styles__Page"
})(["width:25px;height:25px;margin:2px;font-size:16px;line-height:25px;font-family:Roboto;text-align:center;color:white;&:hover{color:pink;border:1px solid pink;border-radius:4px;}"]);
