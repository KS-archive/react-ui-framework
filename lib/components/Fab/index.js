...
function (_PureComponent) {
  ...
  function Fab() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref2 = Fab.__proto__ || Object.getPrototypeOf(Fab)).call.apply(_ref2, [this].concat(args))), _this.state = {
      open: false
