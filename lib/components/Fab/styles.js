...
const getPosition = ({ position, offset }) => {
  switch (position) {
    case 'left top': return `top: ${40 + offset[1]}px; left: ${40 + offset[0]}px;`;
    case 'left center': return `top: calc(50vh + ${offset[1] - 28}px); left: ${40 + offset[0]}px;`;
    case 'left bottom': return `bottom: ${40 + offset[1]}px; left: ${40 + offset[0]}px;`;
    case 'center top': return `top: ${40 + offset[1]}px; left: calc(50vw + ${offset[0] - 28}px);`;
    case 'center bottom': return `bottom: ${40 + offset[1]}px; left: calc(50vw + ${offset[0] - 28}px);`;
    case 'right top': return `top: ${40 + offset[1]}px; right: ${40 + offset[0]}px;`;
    case 'right center': return `top: calc(50vh + ${offset[1] - 28}px); right: ${40 + offset[0]}px;`;
    default: return `bottom: ${40 + offset[1]}px; right: ${40 + offset[0]}px;`;
  }
};
