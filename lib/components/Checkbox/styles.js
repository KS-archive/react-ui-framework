...
})(["cursor:pointer;user-select:none;display:inline-block;position:relative;margin:2px;padding-left:28px;border-radius:4px;&:hover span::after{opacity:0.25;}.error{position:absolute;visibility:", ";top:", ";opacity:", ";left:0;padding-top:2px;font-size:var(--font-xs);color:var(--error);font-weight:var(--regular);transition:all 0.3s var(--ease-in-out);}", ";"], function (_ref) {
...
})(["cursor:pointer;position:relative;top:1px;font-family:var(--mainFont);font-size:var(--font-md);line-height:var(--font-md-lh);font-weight:var(--regular);color:var(--text2);"]);
