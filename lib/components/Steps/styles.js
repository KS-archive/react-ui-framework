...
})(["margin:0;padding:0;display:flex;align-items:center;color:white;"]);

exports.Wrapper = Wrapper;

var Circle = _styledComponents.default.div.withConfig({
  displayName: "styles__Circle"
})(["width:44px;height:44px;border:2px solid #2F80ED;border-radius:50%;line-height:44px;font-size:16px;color:#2F80ED;text-align:center;"]);
