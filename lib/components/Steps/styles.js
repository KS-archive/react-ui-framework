...
})(["width:44px;height:44px;border:2px solid #CCCCCC;border-radius:50%;display:flex;justify-content:center;align-items:center;font-size:16px;color:#CCCCCC;font-family:Roboto;"]);

exports.Circle = Circle;

var Rectangle = _styledComponents.default.div.withConfig({
  displayName: "styles__Rectangle"
})(["width:84px;height:2px;background-color:#CCCCCC;"]);
