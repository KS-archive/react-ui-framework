...
var _default = function _default(WrappedComponent) {
  ...
  function (_PureComponent) {
    ...
    function WithSearch() {
      ...
      return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(WithSearch)).call.apply(_getPrototypeOf2, [this].concat(args))), _this.setSearch = function (queryObj) {
